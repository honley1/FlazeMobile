...
import com.honley.flazemobile.databinding.ActivityLoginBinding;
        ...
        binding.loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (binding.emailEt.getText().toString().isEmpty() ||
                    ...
                    FirebaseAuth.getInstance().signInWithEmailAndPassword(binding.emailEt.
                            getText().toString(), binding.passwordEt.getText().toString()).
